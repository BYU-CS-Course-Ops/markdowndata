...
def test_only_yaml_data():
    build_test(
        ...
        expected_data_file="only_yaml_data.expected.json"
    )
...
def test_only_table_data():
    build_test(
        ...
        expected_data_file="only_table_data.expected.json"
    )
...
def test_only_list_data():
    build_test(
        ...
        expected_data_file="only_list_data.expected.json"
    )
...
def test_only_content_data():
    build_test(
        ...
        expected_data_file="only_content_data.expected.json"
    )
...
def test_small_data():
    build_test(
        ...
        expected_data_file="small_data.expected.json"
    )
...
def test_medium_data():
    build_test(
        ...
        expected_data_file="medium_data.expected.json"
    )
...
def test_md_content_data():
    build_test(
        ...
        expected_data_file="md_content_data.expected.json"
    )
...
def test_all_value_types_data():
    build_test(
        ...
        expected_data_file="all_value_types_data.expected.json"
    )
...
def test_nested_data():
    build_test(
        ...
        expected_data_file="nested_data.expected.json"
    )
...
def test_complex_data():
    build_test(
        ...
        expected_data_file="complex_data.expected.json"
    )
